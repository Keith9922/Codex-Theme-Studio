...
const PRESETS = [
  ...
  },
  {
    ...
    name: "野生博物",
    category: "solid",
    tags: ["纯色", "深色", "博物馆", "橄榄绿", "赭石", "自然"],
    featured: true,
    tagline: "标本柜般的深橄榄色，配一束克制的赭金光。",
    quote: "COLLECT IDEAS, BUILD WORLDS",
    bg: ["#14160f", "#242116"],
    lights: [
      { x: 0.78, y: 0.32, r: 0.58, color: "#8f9b58", intensity: 0.27 },
      { x: 0.94, y: 0.72, r: 0.52, color: "#c58a45", intensity: 0.22 },
      { x: 0.56, y: 0.92, r: 0.48, color: "#58643c", intensity: 0.2 },
    ],
    vignette: 0.34,
    dither: 1.2,
    colors: {
      background: "#14160f", panel: "#202318", panelAlt: "#2b2c1f",
      accent: "#c7a56a", accentAlt: "#dec28d", secondary: "#879455",
      highlight: "#d58942", text: "#f3edda", muted: "#aaa58d",
      line: "rgba(199, 165, 106, .24)",
    },
  },
  {
    slug: "cobalt-studio",
    ...
    category: "solid",
    tags: ["纯色", "深色", "钴蓝", "冷色", "极简"],
    tagline: "深钴蓝铺满工作台，只保留一笔清亮的电光蓝。",
    quote: "SHAPE THE SIGNAL",
    bg: ["#0a1322", "#102847"],
    lights: [
      { x: 0.82, y: 0.34, r: 0.62, color: "#2979ff", intensity: 0.34 },
      { x: 0.92, y: 0.82, r: 0.5, color: "#67b7ff", intensity: 0.2 },
    ],
    vignette: 0.36,
    dither: 1.2,
    colors: {
      background: "#0a1322", panel: "#101f36", panelAlt: "#172d4c",
      accent: "#58a6ff", accentAlt: "#89c2ff", secondary: "#376fd2",
      highlight: "#7cc8ff", text: "#edf6ff", muted: "#90a9c3",
      line: "rgba(88, 166, 255, .24)",
    },
  },
  {
    slug: "vermilion-signal",
    name: "朱砂信号",
    category: "solid",
    tags: ["纯色", "深色", "朱砂", "红色", "工业"],
    tagline: "近黑赤色与朱砂信号灯，干净、直接、有速度。",
    quote: "MAKE THE NEXT MOVE",
    bg: ["#170d0d", "#351514"],
    lights: [
      { x: 0.82, y: 0.38, r: 0.58, color: "#ef4938", intensity: 0.35 },
      { x: 0.94, y: 0.8, r: 0.48, color: "#ff8a55", intensity: 0.2 },
    ],
    vignette: 0.38,
    dither: 1.2,
    colors: {
      background: "#170d0d", panel: "#271515", panelAlt: "#391c1a",
      accent: "#f05b49", accentAlt: "#ff8474", secondary: "#d98a55",
      highlight: "#ffad72", text: "#fff2ed", muted: "#bd9b94",
      line: "rgba(240, 91, 73, .25)",
    },
  },
  {
    slug: "porcelain-paper",
    name: "瓷白纸页",
    category: "solid",
    tags: ["纯色", "浅色", "瓷白", "纸张", "极简"],
    tagline: "温润瓷白与一丝墨蓝，像摊开的纸页一样轻。",
    quote: "CLEAR SPACE, CLEAR THOUGHT",
    blend: "tint",
    bg: ["#f5f1e8", "#e8e1d4"],
    lights: [
      { x: 0.82, y: 0.32, r: 0.62, color: "#d4bb8f", intensity: 0.23 },
      { x: 0.94, y: 0.8, r: 0.5, color: "#b7c8d8", intensity: 0.18 },
    ],
    vignette: 0.06,
    dither: 1.0,
    colors: {
      background: "#f5f1e8", panel: "#fffdf8", panelAlt: "#eee8dc",
      accent: "#264b68", accentAlt: "#3e6f91", secondary: "#b57942",
      highlight: "#274b68", text: "#252c31", muted: "#7c7d78",
      line: "rgba(38, 75, 104, .2)",
    },
  },
];
...
function themeFor(spec) {
  return {
    ...
    catalog: {
      category: spec.category ?? "abstract",
